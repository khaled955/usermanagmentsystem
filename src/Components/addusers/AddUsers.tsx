...
export default function AddUsers() {
  return (
   ...
   <div className="update-user-container p-5 font-bold text-gray-700">
      <h2 className="mb-7 text-red-600">Add User Data</h2>
      <hr />
     <div className="update-user-info mt-4 space-y-5">
        <div className="update-box flex gap-4 flex-wrap">
            <div className="flex-1">
                <label htmlFor="firstname" className="block text-white text-sm font-bold" > First Name</label>
            ...
            <div className="flex-1">
                <label htmlFor="lastname" className="block text-white text-sm font-bold" > Last Name</label>
        ...
        <div className="update-box flex gap-4 flex-wrap">
            ...
            <div className="flex-1">
                <label htmlFor="age" className="block text-white text-sm font-bold" > Age</label>
        ...
        <div className="update-box flex gap-4 flex-wrap">
            <div className="flex-1">
                <label htmlFor="phone" className="block text-white text-sm font-bold" > Phone Number</label>
            ...
            <div className="flex-1">
                <label htmlFor="birth" className="block text-white text-sm font-bold" > BirthDate</label>
